...
models = [
    ...
    Model(
        ...
        provider="openrouter",
        cost=Cost(input=0.30, output=2.50),
        input=_TEXT_IMAGE,
        output=_TEXT_IMAGE_OUT,
    ),
    Model(
        id="google/gemini-3-pro-image-generation-preview",
        name="Gemini 3 Pro Image Preview",
        provider="openrouter",
        cost=Cost(input=2.00, output=12.00),
        input=_TEXT_IMAGE,
        output=_TEXT_IMAGE_OUT,
    ),
    Model(
        id="google/gemini-3.1-flash-image-generation-preview",
        name="Gemini 3.1 Flash Image Preview",
        provider="openrouter",
        cost=Cost(input=0.50, output=3.00),
        input=_TEXT_IMAGE,
        output=_TEXT_IMAGE_OUT,
    ),
    ...
    Model(
        ...
        name="GPT-5 Image",
        provider="openrouter",
        cost=Cost(input=10.00, output=10.00),
        input=_TEXT_IMAGE,
        output=_TEXT_IMAGE_OUT,
    ),
    Model(
        ...
        provider="openrouter",
        cost=Cost(input=2.50, output=2.00),
        input=_TEXT_IMAGE,
        output=_TEXT_IMAGE_OUT,
    ),
    Model(
        ...
        provider="openrouter",
        cost=Cost(input=8.00, output=15.00),
        input=_TEXT_IMAGE,
        output=_TEXT_IMAGE_OUT,
    ),
    # ByteDance
    ...
    Model(
        id="sourceful/riverflow-v2-turbo",
        name="Riverflow V2 Turbo",
        provider="openrouter",
        cost=Cost(),
        input=_TEXT_IMAGE,
        output=_IMAGE,
