...
models = [
    ...
    Model(
        id="fal-ai/runway-gen4/turbo/text-to-video",
    ...
    Model(
        id="fal-ai/hailuo-ai/video-01/image-to-video",
        name="Hailuo Video 01 I2V",
        provider="fal",
        cost=Cost(),
        input=_IMAGE,
        output=_VIDEO,
